    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String userReligion = request.getParameter("religion");
                String userMothertongue = request.getParameter("mothertongue");
                String userCast = request.getParameter("cast");
                ...
                User user = new User(userName, userGender, userReligion, userMothertongue, userCast, userPhone, userAddress, userEmail, userPassword);
                ...
                response.sendRedirect("signedupcontents.jsp");
                return;
